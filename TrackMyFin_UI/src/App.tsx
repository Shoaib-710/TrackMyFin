...
import VoiceExpenseLogger from './components/dashboard/VoiceExpenseLogger';
    ...
    <ThemeProvider>
      <AuthProvider>
        <DataProvider>
          <ToastProvider>
            <Router>
              <div className="genz-app-shell min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
                <NavBar />
